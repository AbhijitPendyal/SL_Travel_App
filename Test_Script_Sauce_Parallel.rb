...
if not driver.find_element(:xpath, "//form[@class='form-horizontal']/div[6]/div/select//option[16]").selected?
    driver.find_element(:xpath, "//form[@class='form-horizontal']/div[6]/div/select//option[16]").click
end
